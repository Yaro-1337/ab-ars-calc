...
lines['neocrimson_mt_depo_ssv']['1'] = [
{
  ...
  joints: [
    ...
    { x: 0 + 75, name: '22', limit: 40 },
    { x: 0 + 75 + 37.5 + 12.5, name: '20', limit: 40 },
    { x: 0 + 75 + 37.5 + 87.5, name: '18', limit: 60 },
    { x: 0 + 75 + 37.5 + 87.5 + 50, name: '16', limit: 60 },
    { x: 0 + 75 + 37.5 + 87.5 + 50 + 37.5, name: '14', limit: 60 },
  ...
  signals: [
    { joint: '22', name: 'Е4м', lenses: 'YGR-w', autostop: 1, guard: 60, y: '14', g: 'NEXT_y', row: -1.5 },
    { joint: '18', name: 'МТ6', lenses: 'YYG-Rw', autostop: 1, guard: 60, shift: 22, y: '4а', yg: 'NEXT_y', g: 'NEXT_yg', row: -1.5 },
    ...
    { joint: '20', name: 'Ч6', lenses: 'YG-Rw', autostop: 1, shift: 0, back: true, double: true },
