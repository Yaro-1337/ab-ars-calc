...
lines['neocrimson_mt_depo_ssv']['1'] = [
{
  ...
  signals: [
    ...
    { joint: '372', name: 'Д', lenses: 'ByW-YRw', autostop: 1, shift: 0, back: true, left: true },
    { joint: '4а', name: 'Вм', lenses: 'BYY-GRw', autostop: 1, shift: -5, back: true, left: true },
    { joint: '18', name: 'Ч8', lenses: 'BYG-Rw', autostop: 1, shift: 0, back: true, double: true },
    { joint: '14', name: 'Ч6', lenses: 'BYY-GRw', autostop: 1, shift: 0, back: true, double: true },
