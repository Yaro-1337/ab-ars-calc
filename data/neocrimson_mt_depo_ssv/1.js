...
lines['neocrimson_mt_depo_ssv']['1'] = [
{
  ...
  joints: [
    ...
    { x: 0 + 75 + 37.5 + 87.5, name: '16', limit: 60 },
    { x: 0 + 75 + 37.5 + 87.5 + 50 + 37.5, name: '14', limit: 60, later: { 60: -1 } },
    { x: 0 + 75 + 37.5 + 87.5 + 29 + 125 + 12.5, name: '12', limit: 60, later: { 60: 1 } },
  ...
  signals: [
    ...
    { joint: '18', name: 'Ч6', lenses: 'YG-Rw', autostop: 1, shift: 0, back: true, double: true },
    { joint: '14', name: 'Ч4', lenses: 'YYG-Rw', autostop: 1, shift: 0, back: true, double: true },
