...
lines['neocrimson_mt_depo_ssv']['5'] = [
{
  ...
  joints: [
    ...
    { x: 0 + 75 + 50, name: '6в', limit: 40, later: { 40: 1 } },
    { x: 0 + 75 + 87.5 + 37.5, name: '6б', limit: 40 },
    { x: 0 + 75 + 87.5 + 37.5 + 50, name: '6а', limit: 40, later: { 40: 1 } },
  ...
  signals: [
    ...
    { joint: '6в', name: 'Ч2', lenses: 'YG-Rw', autostop: 1, shift: 0, back: true, left: true }, 
    { joint: '6а', name: 'Ч4', lenses: 'YYG-Rw', autostop: 1, shift: 0, back: true, left: true }, 
