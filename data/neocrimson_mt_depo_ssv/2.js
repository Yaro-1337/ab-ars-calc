...
lines['neocrimson_mt_depo_ssv']['2'] = [
{
  ...
  joints: [
    ...
    { x: 0 - 5 - 12.5 + 75 + 80 + 23.5 + 112.5 + 112.5 - 37.5, name: '14', limit: 60, later: { 60: 1 } },
    { x: 0 - 5 - 12.5 + 75 + 80 + 23.5 + 112.5 + 112.5 + 75, name: '16', limit: 60, later: { 40: 1, 60: -1 } },
  ...
  signals: [
    ...
    { joint: '12', name: 'Вм', lenses: 'YYG-Rw', autostop: 1, guard: 60, y: '20', g: 'NEXT_y' },
    { joint: '18', name: 'Ч4', lenses: 'YYG-Rw', autostop: 1, guard: 60, y: '20', double: true, left: true },
