...
lines['neocrimson_pn_pn_ssv']['2'] = [
    {
        ...
        joints: [
            ...
            { x: 0 - 25 - 8 + 47, name: '336б', limit: 40 },
            { x: 0 - 25 - 8 + 75, name: '336в', limit: 40 },
            { x: 0 - 25 - 8 + 75 + 75, name: '336г', limit: 40 },
            { x: 0 - 25 - 8 + 75 + 75 + 100, name: '336д', limit: 70, later: { 60: 3, 70: 2 } },
            { x: 0 - 25 - 8 + 75 + 75 + 100 + 100 + 12.5, name: '334', limit: 70, later: { 60: 2, 70: 1 } },
            { x: 0 - 25 - 8 + 75 + 75 + 100 + 100 + 75, name: '334а', limit: 70, later: { 40: 3, 60: 1 } },
            { x: 0 - 25 - 8 + 75 + 75 + 100 + 100 + 75 + 75 + 12.5, name: '332', limit: 70, later: { 40: 2, 60: 1, 70: 2 } },

            { x: 1072 - 5 - 25 - 75 - 75 - 75 - 75 - 75 - 100 + 12.5, name: '330', limit: 70, later: { 40: 1 } },
            { x: 1072 - 5 - 25 - 75 - 75 - 75 - 75 - 75, name: '330а', limit: 70, later: { 40: 1 } },
            { x: 1072 - 5 - 12.5 - 75 - 75 - 75 - 75, name: '330б', limit: 70, later: { 40: 1 } },
            { x: 1072 - 5 - 12.5 - 75 - 75 - 75, name: '328', limit: 70, later: { 40: 1 } },
            { x: 1072 - 5 - 12.5 - 75 - 75, name: '326', limit: 70, later: { 40: 2, 70: -1 } },
            { x: 1072 - 5 - 12.5 - 75, name: '324', limit: 70, later: { 40: 1, 60: -1 } },
            { x: 1072 - 5 - 12.5, name: '322', limit: 60, later: { 40: 1 } },
            { x: 1072 - 5 - 12.5 + 37.5 + 12.5, name: '322а', limit: 40 },
            { x: 1072 - 5 - 12.5 + 75 + 12.5, name: '320', limit: 40 },
            { x: 1072 - 5 - 12.5 + 75 + 75, name: '318', limit: 0 },
            { x: 1072 - 5 - 12.5 + 75 + 75 + 50, name: '316', limit: 0 },
            { x: 1072 - 5 - 12.5 + 75 + 75 + 50 + 50, name: '6', limit: 0 },
            { x: 1072 - 5 - 12.5 + 75 + 75 + 50 + 50 + 50, name: '4', limit: 0 },
        ],
        signals: [
            { joint: '336б', name: 'ПН-334М', lenses: 'yYY-YGR-M-w', autostop: 1, guard: 80, service: 35, y: '336д', g: 'NEXT_g', row: -1.5 },
            { joint: '336г', name: '332', lenses: 'YGR', autostop: 1, guard: 70, service: 40, g: '332' },
            { joint: '334', name: '330', lenses: 'YY-GR', autostop: 1, guard: 70, service: 60, y: '330б', yg: 'NEXT_y', g: 'NEXT_yg' },

            { joint: '330', name: 'АП-328', lenses: 'YYG-Rw', autostop: 1, guard: 60, service: 25, y: '328', yg: 'NEXT_y', g: 'NEXT_yg' },
            { joint: '330а', name: 'АП-326', lenses: 'YYG-Rw', autostop: 1, guard: 60, service: 25, y: '326', yg: 'NEXT_y', g: 'NEXT_yg' },
            { joint: '330б', name: 'АП-324', lenses: 'YYG-Rw', autostop: 1, guard: 60, service: 25, y: '324', yg: 'NEXT_y', g: 'NEXT_yg' },
            { joint: '328', name: 'АП-322', lenses: 'YYG-Rw', autostop: 1, guard: 60, service: 25, y: '322а', yg: 'NEXT_y', g: 'NEXT_yg' },
            { joint: '326', name: 'АП-320', lenses: 'YYG-Rw', autostop: 1, guard: 60, service: 25, y: '320', yg: 'NEXT_y', g: 'NEXT_yg' },
            { joint: '324', name: 'АП-318', lenses: 'YYG-Rw', autostop: 1, guard: 60, y: '318', yg: '6' },

            { joint: '320', name: 'АП-316М', lenses: '', guard: 35, shift: 0 },
            { joint: '316', name: 'АП-314М', lenses: '', guard: 35, shift: 0 },
            { joint: '324', name: 'АП-ОП4', lenses: 'zR', autostop: 1, shift: 0, back: true, row: -1.5 },
