...
lines['neocrimson_pn_pn_ssv']['2'] = [
    {
        ...
        signals: [
            ...
            { joint: '326', name: 'ОП', gmod: { name: 'АП-ОП' }, lenses: 'zR', autostop: 1, shift: 0, back: true, row: -1.5 },
            { joint: '336в', name: 'ДОП2', gmod: { name: 'ПН-ДОП2' }, lenses: 'zr', back: true },
        ],
        mks: [
        ],
        switches: [
    ...
    },
    {
        ...
        joints: [
            ...
            { x: 0 - 5 - 12.5 + 75 + 75 + 50, name: '320а', limit: 60, later: { 40: 3, 60: 2 } },
        ...
        signals: [
            ...
            { joint: '4', name: 'АП-2', lenses: 'YW-Rw-M', autostop: 1, back: true, left: true, shift: -11 },
