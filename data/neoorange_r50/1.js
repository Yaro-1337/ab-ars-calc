...
lines['neoorange_r50']['1'] = [
    ...
    },
    {
        ...
        joints: [
            { x: 0 + 3.5, name: '301', limit: 60 },

            { x: 993 - 2 + 75 - 75 - 62.5 - 75 - 75 - 100 - 100 - 100 - 100 - 150 - 150, name: '303', limit: 60, later: { 60: 2 } },
            { x: 993 - 2 + 75 - 75 - 62.5 - 75 - 75 - 100 - 100 - 100 - 100 - 150 - 75, name: '307', limit: 60, later: { 60: 2 } },
            { x: 993 - 2 + 75 - 75 - 62.5 - 75 - 75 - 100 - 100 - 100 - 100 - 150, name: '307а', limit: 60, later: { 60: 1 } },
            ...
            { x: 993 - 2 + 75 - 75 - 62.5, name: '317', limit: 60 },
            { x: 993 - 2 + 75 - 75, name: '319', limit: 60 },
            { x: 993 - 2 + 75, name: '321', limit: 40 },
            { x: 993 - 2 + 75 + 75, name: '1001', limit: 0 },
            { x: 993 - 2 + 75 + 75 + 62.5, name: '1001а', limit: 0 },
        ],
        signals: [
            { joint: '303', name: '307', lenses: 'YYG-Rz', autostop: 1, guard: 35, y: '307в', yg: 'NEXT_y', g: 'NEXT_yg' },
            ...
            { joint: '315', name: '319', lenses: 'YY-GR', autostop: 1, guard: 63, service: 35, y: '319', g: 'NEXT_yg' },
            { joint: '317', name: 'АП-331', lenses: 'YYG-Rw', autostop: 1, guard: 63, yg: '321' },
